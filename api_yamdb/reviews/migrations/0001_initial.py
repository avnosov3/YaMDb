# Generated by Django 2.2.16 on 2022-09-24 16:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Уникальный индетификатор')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='review',
            constraint=models.UniqueConstraint(fields=('title', 'author'), name='Проверка повторного отзыва'),
        ),
        migrations.AddConstraint(
            model_name='user',
